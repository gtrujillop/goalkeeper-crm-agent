...
| [DEL-004](DEL-004-whatsapp-messaging.md) | WhatsApp messaging | In Review | `deliverable/DEL-004-whatsapp-messaging` | [#3](https://github.com/gtrujillop/goalkeeper-crm-agent/pull/3) | No |
