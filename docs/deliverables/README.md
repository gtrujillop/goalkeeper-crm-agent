...
| [DEL-003](DEL-003-shopify-catalogue-and-cart.md) | Shopify catalogue and cart | In Review | `deliverable/DEL-003-shopify-catalogue-cart` | [#2](https://github.com/gtrujillop/goalkeeper-crm-agent/pull/2) | No |
